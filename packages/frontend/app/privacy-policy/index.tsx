      ...
      <div data-custom-class="body" className={style.privacyPolicy}>
          ...
          <span style={{ color: "#7F7F7F" }}>
            <span style={{ color: "#595959", fontSize: "15px" }}>
              <span data-custom-class="body_text">
                This privacy notice for Mob On Software S.L. ("
        ...
        <ul>
          <li style={{ lineHeight: 1.5 }}>
            <span style={{ fontSize: "15px", color: "#595959" }}>
              <span style={{ fontSize: "15px", color: "#595959" }}>
                <span data-custom-class="body_text">
                  Visit our website at mobon.io
                  <span style={{ fontSize: "15px" }}>
                    <span style={{ color: "#595959" }}>
                      <span data-custom-class="body_text">
                        <span style={{ fontSize: "15px" }}>
        ...
        <div>
          <div className={style["block-component"]}>
            <span style={{ fontSize: "15px" }}>
              <span style={{ fontSize: "15px" }}>
                <span style={{ color: "#7F7F7F" }}>
                  <span data-custom-class="body_text">
                      ...
                      <span style={{ color: "#595959" }}>
                        <span data-custom-class="body_text">
                          <span style={{ fontSize: "15px" }}>
                            <span style={{ color: "#595959" }}>
                              <div
                                className={style["statement-end-if-in-editor"]}
                              ></div>
                            </span>
                          </span>
                        </span>
            ...
            <span style={{ fontSize: "15px" }}>
              <span style={{ color: "#7F7F7F" }}>
                <span data-custom-class="body_text">
                  ...
                  questions or concerns, please contact us at gdpr@mobon.io.
                </span>
              </span>
            </span>
          </div>
          ...
          <div style={{ lineHeight: 1.5 }}>
            <span style={{ fontSize: "15px" }}>
              <span data-custom-class="body_text">
                ...
                personal information depending on how you interact with Mob On
                Software S.L. and the Services, the choices you make, and the
          ...
          <div style={{ lineHeight: 1.5 }}>
            <span style={{ fontSize: "15px" }}>
              <span data-custom-class="body_text">
                ...
                <div className={style["else-block"]}></div>
              </span>
            </span>
          </div>
          <div style={{ lineHeight: 1.5 }}>
          ...
          <div style={{ lineHeight: 1.5 }}>
            ...
            <a
              ...
              href="https://app.termly.io/notify/9f828ab9-b609-4351-a99c-0ed09518139f"
          ...
          <div style={{ lineHeight: 1.5 }}>
            <span style={{ fontSize: "15px" }}>
              <span data-custom-class="body_text">
                Want to learn more about what Mob On Software S.L. does with any
          ...
          <div id="infocollect" style={{ lineHeight: 1.5 }}>
            <span style={{ color: "#7F7F7F" }}>
              <span style={{ color: "#595959", fontSize: "15px" }}>
                <span style={{ fontSize: "15px", color: "#595959" }}>
                  <span style={{ fontSize: "15px", color: "#595959" }}>
                    <span id="control" style={{ color: "#000" }}>
                      <strong>
          ...
          <div id="personalinfo" style={{ lineHeight: 1.5 }}>
            <span data-custom-class="heading_2" style={{ color: "#000" }}>
              <span style={{ fontSize: "15px" }}>
            ...
            <span style={{ fontSize: "15px", color: "#595959" }}>
              <span style={{ fontSize: "15px", color: "#595959" }}>
                <span data-custom-class="body_text">
                  ...
                  <span style={{ fontSize: "15px" }}>
                    <span data-custom-class="body_text">
                      <div className={style["forloop-component"]}></div>
                    </span>
                  </span>
                </span>
              </span>
                                  ...
                                  >
                                    ...
                                    >
                                      <span data-custom-class="body_text">
                                        <div
                                          className={
                                            style["statement-end-if-in-editor"]
                                          }
                                        ></div>
                                      </span>
                                    </span>
                            ...
                            <li style={{ lineHeight: 1.5 }}>
                              <span style={{ fontSize: "15px" }}>
                                <span data-custom-class="body_text">
                                  ...
                                  display{" "}
                                  <div
                                    className={style["block-component"]}
                                  ></div>
                                  personalized
                                  <div
                                    className={
                                            ...
                                            <div style={{ lineHeight: 1.5 }}>
                                              <span data-custom-class="body_text">
                                                ...
                                                >
                                                  ...
                                                  laws of the personal
                                                  information described in this
                                                  privacy notice, since we
                                                  determine the means and/or
                                            ...
                                            <div style={{ lineHeight: 1.5 }}>
                                              ...
                                              >
                                                <span data-custom-class="body_text">
                                                  ...
                                                  with our third parties, which
                                                  are designed to help safeguard
                                                  your personal information.
                                                  This means that they cannot do
                                                  anything with your personal
                                                  information unless we have
                                                  instructed them to do it. They
                                                  will also not share your
                                                  ...
                                                  they hold on our behalf and to
                                                  retain it for the period we
                                                  instruct.{" "}
                                                  <div
                                                    className={
                                                      style[
