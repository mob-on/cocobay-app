...
const LevelingContext = createContext({ data: defaultLevelingData, setData: () => {}, setTaps: () => {}} as ILevelingContext);
  
export const useLevelingData = () => useContext(LevelingContext);
export default LevelingContext;

export const LevelingContextProvider = ({ children }: { children: React.JSX.Element }) => {
